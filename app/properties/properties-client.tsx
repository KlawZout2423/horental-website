...
export default function PropertiesClient() {
  ...
  return (
    <div className={`${styles.container} animate-fade-in`}>
      <h1 className={styles.title} style={{ marginBottom: '16px' }}>Search Properties</h1>

      {/* Category Chips Bar with Self-Contained Dropdown */}
      <div className={styles.chipsOuter} style={{ paddingBottom: '8px', marginBottom: '8px' }}>
        <div className={styles.chipsContainer}>
          {TYPE_CHIPS.map((chip) => {
            const isSelected = propertyType === chip.type || 
      ...
      <div className={styles.chipsOuter} style={{ paddingTop: 0, paddingBottom: '12px', marginBottom: '16px' }}>
        <div className={styles.chipsContainer}>
